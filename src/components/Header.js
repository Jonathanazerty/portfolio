        ...
        <div class="collapse" id="navbarToggleExternalContent">
          <div class="bg-transparent p-4">
            ...
            {/* <div class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="/Projects" id="dropdownMenuOffset" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  data-bs-offset="10,20">
                Projects
                </a> */}
            ...
            <span class="text-muted">It's all about the journey !</span>
          </div>
        </div>
